Contributing to CCCoin Core
============================

The CCCoin Core project operates an open contributor model where anyone is
...
Examples:
    ...
    Consensus: Add new opcode for BIP-CCCOINX OP_CHECKAWESOMESIG
...
The following applies to code changes to the CCCoin Core project, and is not to be
confused with overall CCCoin Network Protocol consensus changes.

Whether a pull request is merged into CCCoin Core rests with the project merge
...
Patches that change CCCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the CCCoin consensus, it must have been
...
The project leader is the release manager for each CCCoin Core release.
