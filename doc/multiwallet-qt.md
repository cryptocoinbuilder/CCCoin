...
In order to support loading of multiple wallets in cccoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cccoin.cpp.
...
Changes to cccoin.cpp
----------------------
cccoin.cpp is the entry point into cccoin-qt, and as such, will require some minor modifications to provide hooks for
