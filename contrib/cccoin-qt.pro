...
RESOURCES += src/qt/cccoin.qrc src/qt/cccoin_locale.qrc

TRANSLATIONS += src/qt/locale/cccoin_bg.ts \
                src/qt/locale/cccoin_de.ts \
                src/qt/locale/cccoin_en.ts \
                src/qt/locale/cccoin_es.ts \
                src/qt/locale/cccoin_fi.ts \
                src/qt/locale/cccoin_fr.ts \
                src/qt/locale/cccoin_it.ts \
                src/qt/locale/cccoin_ja.ts \
                src/qt/locale/cccoin_pl.ts \
                src/qt/locale/cccoin_pt.ts \
                src/qt/locale/cccoin_ru.ts \
                src/qt/locale/cccoin_sk.ts \
                src/qt/locale/cccoin_sv.ts \
                src/qt/locale/cccoin_vi.ts \
                src/qt/locale/cccoin_zh_CN.ts \
                src/qt/locale/cccoin_zh_TW.ts
