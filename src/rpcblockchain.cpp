...
Object blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zcccoinObj.push_back(Pair(to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zcccoinObj.emplace_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
    result.emplace_back(Pair("zCCCOINsupply", zcccoinObj));
...
Value getrawmempool(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in cccoin\n"
...
Value getblock(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"merkleroot\" : \"cccoinx\", (string) The merkle root\n"
            ...
            "  \"difficulty\" : x.cccoin,  (numeric) The difficulty\n"
...
Value gettxoutsetinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"total_amount\": x.cccoin          (numeric) The total amount\n"
            "}\n"
            "\nExamples:\n" +
...
Value gettxout(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "  \"value\" : x.cccoin,           (numeric) The transaction value in btc\n"
...
Value getblockchaininfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"chain\": \"cccoinx\",        (string) current network name as defined in BIP70 (main, test, regtest)\n"
            "  \"blocks\": cccoincccoin,         (numeric) the current number of blocks processed in the server\n"
            "  \"headers\": cccoincccoin,        (numeric) the current number of headers we have validated\n"
            "  \"bestblockhash\": \"...\", (string) the hash of the currently best block\n"
            "  \"difficulty\": cccoincccoin,     (numeric) the current difficulty\n"
            "  \"verificationprogress\": cccoinx, (numeric) estimate of verification progress [0..1]\n"
            "  \"chainwork\": \"cccoinx\"     (string) total amount of work in active chain, in hexadecimal\n"
            "}\n"
            "\nExamples:\n" +
...
Value getchaintips(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"height\": cccoinx,         (numeric) height of the chain tip\n"
            "    \"hash\": \"cccoinx\",         (string) block hash of the tip\n"
            ...
            "    \"status\": \"cccoinx\"        (string) status of the chain (active, valid-fork, valid-headers, headers-only, invalid)\n"
            "  }\n"
            "]\n"
...
Value getmempoolinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"size\": cccoinxx                (numeric) Current tx count\n"
            "  \"bytes\": cccoinxx               (numeric) Sum of all tx sizes\n"
            "}\n"
            "\nExamples:\n" +
