...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"version\": cccoinxx,           (numeric) the server version\n"
            "  \"protocolversion\": cccoinxx,   (numeric) the protocol version\n"
            "  \"walletversion\": cccoinxx,     (numeric) the wallet version\n"
            "  \"balance\": cccoincccoinx,         (numeric) the total cccoin balance of the wallet (excluding zerocoins)\n"
            "  \"zerocoinbalance\": cccoincccoinx, (numeric) the total zerocoin balance of the wallet\n"
            "  \"blocks\": cccoincccoin,           (numeric) the current number of blocks processed in the server\n"
            "  \"timeoffset\": cccoinxx,        (numeric) the time offset\n"
            "  \"connections\": cccoinxx,       (numeric) the number of connections\n"
            "  \"proxy\": \"host:port\",     (string, optional) the proxy used by the server\n"
            "  \"difficulty\": cccoincccoin,       (numeric) the current difficulty\n"
            "  \"testnet\": true|false,      (boolean) if the server is using testnet or not\n"
            "  \"moneysupply\" : \"supply\"       (numeric) The money supply when this block was added to the blockchain\n"
            "  \"zCCCOINsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zCCCOIN denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zCCCOIN denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zCCCOIN denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zCCCOIN denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zCCCOIN denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zCCCOIN denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zCCCOIN denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zCCCOIN denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zCCCOIN denominations\n"
            "  }\n"
            ...
            "  \"paytxfee\": x.cccoinx,         (numeric) the transaction fee set in cccoin/kb\n"
            "  \"relayfee\": x.cccoinx,         (numeric) minimum relay fee for non-free transactions in cccoin/kb\n"
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zcccoinObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zcccoinObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zCCCOINsupply", zcccoinObj));
...
Value mnsync(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1 || (strMode != "status" && strMode != "reset")) {
        throw runtime_error(
            ...
            "  \"lastMasternodeList\": cccoinx,        (numeric) Timestamp of last MN list message\n"
            "  \"lastMasternodeWinner\": cccoinx,      (numeric) Timestamp of last MN winner message\n"
            "  \"lastBudgetItem\": cccoinx,            (numeric) Timestamp of last MN budget message\n"
            "  \"lastFailure\": cccoinx,           (numeric) Timestamp of last failed sync\n"
...
#ifdef ENABLE_WALLET
        // Case 1: CCCoin address and we have full public key:
