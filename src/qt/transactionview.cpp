                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received CCCoin from zCCCoin"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCCCoin"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zXxx));
