...
/** Utility functions used by the CCCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CCCoin addresses in monospace font
...
// Parse "cccoin:" URI into recipient object, return true on successful parsing
