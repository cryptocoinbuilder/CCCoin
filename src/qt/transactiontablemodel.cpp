...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted CCCoin to zCCCoin");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zCCCoin");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received CCCoin from zCCCoin");
    case TransactionRecord::ZerocoinSpend_Change_zXxx:
        return tr("Minted Change as zCCCoin from zCCCoin Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zCCCoin to CCCoin");
