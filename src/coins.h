...
/** 
    ...
    ****Note - for CCCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of cccoin coming in to a transaction
