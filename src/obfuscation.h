...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 CCCoin - checking if valid masternode)
...
private:
    ...
    unsigned int state; // should be one of the POOL_STATUS_CCCOIN values
...
public:
    ...
    /// Get the denominations for a specific amount of cccoin.
