...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CCCoin features */
        {"cccoin", "masternode", &masternode, true, true, false},
        {"cccoin", "listmasternodes", &listmasternodes, true, true, false},
        {"cccoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cccoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cccoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cccoin", "masternodedebug", &masternodedebug, true, true, false},
        {"cccoin", "startmasternode", &startmasternode, true, true, false},
        {"cccoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cccoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cccoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cccoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cccoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cccoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cccoin", "mnbudget", &mnbudget, true, true, false},
        {"cccoin", "preparebudget", &preparebudget, true, true, false},
        {"cccoin", "submitbudget", &submitbudget, true, true, false},
        {"cccoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cccoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cccoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cccoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cccoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cccoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cccoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cccoin", "checkbudgets", &checkbudgets, true, true, false},
        {"cccoin", "mnsync", &mnsync, true, true, false},
        {"cccoin", "spork", &spork, true, true, false},
        {"cccoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cccoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
