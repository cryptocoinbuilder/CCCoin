...
Value getmininginfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"difficulty\": cccoin.cccoinxx    (numeric) The current difficulty\n"
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "  \"previousblockhash\" : \"cccoinx\",    (string) The hash of current highest block\n"
            "  \"transactions\" : [                (array) contents of non-coinbase transactions that should be included in the next block\n"
            "      {\n"
            "         \"data\" : \"cccoinx\",          (string) transaction data encoded in hexadecimal (byte-for-byte)\n"
            "         \"hash\" : \"cccoinx\",          (string) hash/id encoded in little-endian hexadecimal\n"
            ...
            "  \"target\" : \"cccoinx\",               (string) The hash target\n"
            "  \"mintime\" : cccoin,                   (numeric) The minimum timestamp appropriate for next block time in seconds since epoch (Jan 1 1970 GMT)\n"
            ...
            "  \"bits\" : \"cccoin\",                 (string) compressed target of next block\n"
            "  \"height\" : n                      (numeric) The height of the next block\n"
            "  \"payee\" : \"cccoin\",                (string) required payee for the next block\n"
