...
Value obfuscation(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() == 0)
        throw runtime_error(
            "obfuscation <cccoinaddress> <amount>\n"
            "cccoinaddress, reset, or auto (AutoDenominate)"
    ...
    if (params.size() != 2)
        throw runtime_error(
            "obfuscation <cccoinaddress> <amount>\n"
            "cccoinaddress, denominate, or auto (AutoDenominate)"
            "<amount> is a real and will be rounded to the next 0.1" +
            HelpRequiringPassphrase());
...
Value getpoolinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"current\": \"addr\",    (string) CCCoin address of current masternode\n"
            "  \"state\": cccoinx,        (string) unknown\n"
            "  \"entries\": cccoinx,      (numeric) Number of entries\n"
            "  \"accepted\": cccoinx,     (numeric) Number of entries accepted\n"
            "}\n"
...
Value masternode(const Array& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  start        - Start masternode configured in cccoin.conf\n"
...
Value listmasternodes(const Array& params, bool fHelp)
{
    ...
    if (fHelp || (params.size() > 1))
        throw runtime_error(
            ...
            "    \"addr\": \"addr\",      (string) Masternode CCCoin address\n"
...
Value masternodecurrent (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"protocol\": cccoinx,        (numeric) Protocol version\n"
            "  \"txhash\": \"cccoinx\",      (string) Collateral transaction hash\n"
            "  \"pubkey\": \"cccoinx\",      (string) MN Public key\n"
            "  \"lastseen\": cccoin,       (numeric) Time since epoch of last seen\n"
            "  \"activeseconds\": cccoin,  (numeric) Seconds MN has been active\n"
            "}\n"
            "\nExamples:\n" +
...
Value startmasternode (const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3 ||
        ...
        throw runtime_error(
            ...
            "{\n"
            "  \"overall\": \"cccoinx\",     (string) Overall status message\n"
            "  \"detail\": [\n"
            "    {\n"
            "      \"node\": \"cccoinx\",    (string) Node name or alias\n"
            "      \"result\": \"cccoinx\",  (string) 'success' or 'failed'\n"
            "      \"error\": \"cccoinx\"    (string) Error message, if failed\n"
            "    }\n"
            "    ,...\n"
            "  ]\n"
            "}\n"
...
Value getmasternodeoutputs (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"txhash\": \"cccoinx\",    (string) output transaction hash\n"
...
Value listmasternodeconf (const Array& params, bool fHelp)
{
    ...
    if (fHelp || (params.size() > 1))
        throw runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"alias\": \"cccoinx\",        (string) masternode alias\n"
            "    \"address\": \"cccoinx\",      (string) masternode IP address\n"
            "    \"privateKey\": \"cccoinx\",   (string) masternode private key\n"
            "    \"txHash\": \"cccoinx\",       (string) transaction hash\n"
            "    \"outputIndex\": n,       (numeric) transaction output index\n"
            "    \"status\": \"cccoinx\"        (string) masternode status\n"
            "  }\n"
            "  ,...\n"
            "]\n"
...
Value getmasternodestatus (const Array& params, bool fHelp)
{
    if (fHelp || (params.size() != 0))
        throw runtime_error(
            ...
            "  \"netaddr\": \"cccoinx\",     (string) Masternode network address\n"
            "  \"addr\": \"cccoinx\",        (string) CCCoin address for masternode payments\n"
            "  \"status\": \"cccoinx\",      (string) Masternode status\n"
            "  \"message\": \"cccoinx\"      (string) Masternode status message\n"
            "}\n"
...
Value getmasternodewinners (const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "    \"winner\": {\n"
            "      \"address\": \"cccoinx\",    (string) CCCoin MN Address\n"
...
Value getmasternodescores (const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  cccoinx: \"cccoinx\"   (numeric : string) Block height : Masternode hash\n"
            "  ,...\n"
            "}\n"
            "\nExamples:\n" +
