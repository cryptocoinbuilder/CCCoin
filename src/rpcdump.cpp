...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"cccoinaddress\"\n"
            "\nEncrypts a private key corresponding to 'cccoinaddress'.\n"
            "\nArguments:\n"
            "1. \"cccoinaddress\"   (string, required) The cccoin address for the private key (you must hold the key already)\n"
