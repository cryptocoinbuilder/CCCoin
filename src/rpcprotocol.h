...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! CCCoin is not connected
    ...
    RPC_WALLET_PASSCCCOINASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
